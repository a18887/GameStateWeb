            ...
            <Grid container spacing={10}>
                <Grid xs={12} sm={6} md={4}>
                    <div className={styles.divimg}>                  
                        ...
                        <p className={styles.pclass1}>Joined: {userdata.day}/{userdata.month}/{userdata.year}</p>
                ...
                <Grid xs={12} sm={6} md={4}>
                    ...
                    <div className={styles.divflexgamesection}>
                        <div className={styles.divflexgamesectionrating}>
                            <div className={styles.frame}>
                                <div className={styles.frameGameImage}>
                                    <img src={lastreview.image} alt="game" id={styles.subscribedGames} />
                                </div>   
                            </div>
                        ...
                        <div className={styles.divflexgamesectiontext}>
                            ...
                            <h5>Posted {reviewlastdata.day} {reviewlastdata.month} {reviewlastdata.year}</h5>
                        </div>
                    </div>
                ...
                <Grid xs={12} sm={6} md={4}>
                    ...
                    <div className={styles.divflexgamesection}>
                        <div className={styles.divflexgamesectionrating}>
                            <div className={styles.frame}>
                                <div className={styles.frameGameImage}>
                                    <img src={lasttopicimage} alt="game" id={styles.subscribedGames} />
                                </div>   
                            </div>
                        </div>
                        <div className={styles.divflexgamesectiontext}>
                            ...
                            <h5>Posted {topiclastdata.day} {topiclastdata.month} {topiclastdata.year}</h5>
                        </div>
                    </div>
                </Grid>
          </Grid>
            ...
            <Grid xs={12} sm={6} md={3}>
                ...
                {reviews.map((review)=> (
                    <Grid xs={12} sm={6} key={review._id}>
                        ...
                        <div className={styles.frameGameImage}>
                            <img src={review.image} alt="game" id={styles.subscribedGames} />
                        </div>   
            ...
            <Grid xs={12} sm={6} md={3}>
              ...
              {topics.map((topic, index) => (       
                <Grid item={"true"} xs={12} md={12} key={topic._id}> 
                    <div className={styles.frameGameImage}>
                        <img src={topicImages[index]} alt="game" id={styles.subscribedGames} />
                    </div> 
                </Grid>  
                 ))}        
                </Grid>    
