      ...
      if (xhr.status === 201) {
        ...
        if (enter == 0){
          for(let i = 0;i<data.message.topics.comments.length;i++){
            setcommenttext(prevArray => [...prevArray, data.message.topics.comments[i].text]);
            setcommentusername(prevArray => [...prevArray, data.message.topics.comments[i].username]);
          ...
          <div className="col-lg-3">
              <div class="img-container">
                  ...
                  <div className='imagebackground'>
                      <img src={imagegamebackground}  height="550px" className='gameimgback' alt="background" ></img>
                  </div>
              </div>
          </div>
               ...
               <div className='topicdivgame'>
                ...
                <div className='seconddivtopic'>
                          ...
                          <div className="topiccommentmain">
                            <div className="topiccomment">
                                ...
                                <div className='topicdesc'>
                                  <p className="topictext"><span className="topictextname">{usernametopic}</span> {timedata.day} {timedata.month} {timedata.year}</p>
                                </div>
                              </div>
                        ...
                        <div className='edittexttopic'> 
                            <textarea rows="9" cols="10" placeholder="Write a comment" id='buttoncomment' autocomplete="off" onChange={(e) => settext(e.target.value)}
                            value={text}/>
                        </div>
                        <div className="commentbuttondivmain">
                          <div className='editbuttoncomment'>
                            <input type="submit" id='buttoncommentadd' name="log"  onClick={commentinput} value="ADD COMMENT" />   
                          </div>
                        </div>
                                ...
                                <div className="commentsflex">         
                                  <div className="userimage">
                                    ...
                                    <div className="divcomment">
                                      <p className="topictextuser" key={index}>{commentusername[index]}</p>
                                      <p className="textcomment" key={index}>{commenttext[index]}</p>
                                    </div>
                                  </div>
                                  <div className="userimage">
                                    <p className="textdatatopiccomment"key={index}>{typeof commentdate[index] !== 'string' ? (
                                      <>
                                        {commentdate[index].day} {commentdate[index].month} {commentdate[index].year}
                                      </>
                                    ) : (
                                      commentdate[index]
                                    )}</p>
